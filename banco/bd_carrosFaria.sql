...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_devolucao` (
  ...
  `tb_aluguel_tb_veiculo_id_veiculo` INT NOT NULL,
  `tb_aluguel_tb_funcionario_id_funcionario` INT NOT NULL,
  PRIMARY KEY (`id_devolucao`, `tb_aluguel_id_aluguel`, `tb_aluguel_tb_veiculo_id_veiculo`, `tb_aluguel_tb_funcionario_id_funcionario`),
  INDEX `fk_tb_devolucao_tb_aluguel1_idx` (`tb_aluguel_id_aluguel` ASC, `tb_aluguel_tb_veiculo_id_veiculo` ASC, `tb_aluguel_tb_funcionario_id_funcionario` ASC) VISIBLE,
  CONSTRAINT `fk_tb_devolucao_tb_aluguel1`
    FOREIGN KEY (`tb_aluguel_id_aluguel` , `tb_aluguel_tb_funcionario_id_funcionario`)
    REFERENCES `mydb`.`tb_aluguel` (`id_aluguel` , `tb_funcionario_id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_veiculo_has_tb_aluguel` (
  ...
  `tb_aluguel_id_aluguel` INT NOT NULL,
  `tb_aluguel_tb_funcionario_id_funcionario` INT NOT NULL,
  `tb_aluguel_tb_cliente_id_cliente` INT NOT NULL,
  PRIMARY KEY (`tb_veiculo_id_veiculo`, `tb_aluguel_id_aluguel`, `tb_aluguel_tb_funcionario_id_funcionario`, `tb_aluguel_tb_cliente_id_cliente`),
  INDEX `fk_tb_veiculo_has_tb_aluguel_tb_aluguel1_idx` (`tb_aluguel_id_aluguel` ASC, `tb_aluguel_tb_funcionario_id_funcionario` ASC, `tb_aluguel_tb_cliente_id_cliente` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_veiculo_has_tb_aluguel_tb_aluguel1`
    FOREIGN KEY (`tb_aluguel_id_aluguel` , `tb_aluguel_tb_funcionario_id_funcionario` , `tb_aluguel_tb_cliente_id_cliente`)
    REFERENCES `mydb`.`tb_aluguel` (`id_aluguel` , `tb_funcionario_id_funcionario` , `tb_cliente_id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
